# Name:- Gupta Suryansh Jayprakash
# Task4:- Weather App
import math
from tkinter import *
...
# labels
label1=Label(root,text="Temperature",font=("Georgia",11),fg="white",bg="#203243")
label1.place(x=40,y=120)

label2=Label(root,text="Humidity",font=("Georgia",11),fg="white",bg="#203243")
label2.place(x=40,y=140)

label3=Label(root,text="Pressure",font=("Georgia",11),fg="white",bg="#203243")
label3.place(x=40,y=160)

label4=Label(root,text="Wind Speed",font=("Georgia",11),fg="white",bg="#203243")
label4.place(x=40,y=180)

label5=Label(root,text="Description",font=("Georgia",11),fg="white",bg="#203243")
...
textfield=Entry(root,justify="center",width=15,font=("Georgia",15,'bold'),bg="#203243",border=0,fg="white")
...
#Bottom box
frame=Frame(root,width=910,height=180,bg="#212120")
...
Label(frame,image=firstbox,bg="#212120",font=("Georgia",11)).place(x=30,y=20)
Label(frame,image=secondbox,bg="#212120",font=("Georgia",11)).place(x=300,y=30)
Label(frame,image=secondbox,bg="#212120",font=("Georgia",11)).place(x=400,y=30)
Label(frame,image=secondbox,bg="#212120",font=("Georgia",11)).place(x=500,y=30)
Label(frame,image=secondbox,bg="#212120",font=("Georgia",11)).place(x=600,y=30)
Label(frame,image=secondbox,bg="#212120",font=("Georgia",11)).place(x=700,y=30)
Label(frame,image=secondbox,bg="#212120",font=("Georgia",11)).place(x=800,y=30)


#clock
clock=Label(root,font=("Georgia",13,'bold'),fg="white",bg="#57adff")
clock.place(x=30,y=20)


#timezone
timezone=Label(root,font=("Georgia",13,'bold'),fg="white",bg="#57adff")
timezone.place(x=700,y=20)

long_lat=Label(root,font=("Georgia",12,'bold'),fg="white",bg="#57adff")
long_lat.place(x=700,y=50)

#thpwd
t=Label(root,font=("Georgia",11),fg="white",bg="#203242")
t.place(x=140,y=120)
h=Label(root,font=("Georgia",11),fg="white",bg="#203242")
h.place(x=140,y=140)
p=Label(root,font=("Georgia",11),fg="white",bg="#203242")
p.place(x=140,y=160)
w=Label(root,font=("Georgia",11),fg="white",bg="#203242")
w.place(x=140,y=180)
d=Label(root,font=("Georgia",11),fg="white",bg="#203242")
d.place(x=140,y=200)

#first cell
firstframe=Frame(root,width=250,height=135,bg="#282829")
firstframe.place(x=35,y=315)

day1=Label(firstframe,font=("Georgia",13),bg="#282829",fg="#fff")
day1.place(x=100,y=5)

firstimage=Label(firstframe,bg="#282829")
firstimage.place(x=1,y=15)

day1temp=Label(firstframe,bg="#282829",fg="#57adff",font=("Georgia",13,'bold'))
day1temp.place(x=100,y=50)

#second cell
secondframe=Frame(root,width=80,height=120,bg="#282829")
secondframe.place(x=305,y=325)

day2=Label(secondframe,bg="#282829",fg="#fff",font=("Georgia",11))
day2.place(x=10,y=5)

secondimage=Label(secondframe,bg="#282829",font=("Georgia",11))
secondimage.place(x=7,y=20)

day2temp=Label(secondframe,bg="#282829",fg="#fff",font=("Georgia",11))
day2temp.place(x=10,y=70)

#third cell
thirdframe=Frame(root,width=80,height=120,bg="#282829")
thirdframe.place(x=405,y=325)

day3=Label(thirdframe,bg="#282829",fg="#fff",font=("Georgia",11))
day3.place(x=5,y=5)

thirdimage=Label(thirdframe,bg="#282829")
thirdimage.place(x=7,y=20)

day3temp=Label(thirdframe,bg="#282829",fg="#fff",font=("Georgia",11))
day3temp.place(x=10,y=70)

#fourth cell
fourthframe=Frame(root,width=80,height=120,bg="#282829")
fourthframe.place(x=505,y=325)

day4=Label(fourthframe,bg="#282829",fg="#fff",font=("Georgia",11))
day4.place(x=10,y=5)

fourthimage=Label(fourthframe,bg="#282829")
fourthimage.place(x=7,y=20)

day4temp=Label(fourthframe,bg="#282829",fg="#fff",font=("Georgia",11))
day4temp.place(x=10,y=70)

#fifth cell
fifthframe=Frame(root,width=80,height=120,bg="#282829",)
fifthframe.place(x=605,y=325)

day5=Label(fifthframe,bg="#282829",fg="#fff",font=("Georgia",11))
day5.place(x=10,y=5)

fifthimage=Label(fifthframe,bg="#282829",font=("Georgia",11))
fifthimage.place(x=7,y=20)

day5temp=Label(fifthframe,bg="#282829",fg="#fff",font=("Georgia",11))
day5temp.place(x=10,y=70)

#sixth cell
sixthframe=Frame(root,width=80,height=120,bg="#282829",)
sixthframe.place(x=705,y=325)

day6=Label(sixthframe,bg="#282829",fg="#fff",font=("Georgia",11))
day6.place(x=10,y=5)

sixthimage=Label(sixthframe,bg="#282829",)
sixthimage.place(x=7,y=20)

day6temp=Label(sixthframe,bg="#282829",fg="#fff",font=("Georgia",11))
day6temp.place(x=10,y=70)

#seventh cell
seventhframe=Frame(root,width=80,height=120,bg="#282829",)
seventhframe.place(x=805,y=325)

day7=Label(seventhframe,bg="#282829",fg="#fff",font=("Georgia",11))
day7.place(x=10,y=5)

seventhimage=Label(seventhframe,bg="#282829",)
seventhimage.place(x=7,y=20)

day7temp=Label(seventhframe,bg="#282829",fg="#fff",font=("Georgia",11))
